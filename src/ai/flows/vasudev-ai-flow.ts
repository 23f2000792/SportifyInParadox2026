...
1. FOOTBALL (Paradox Champions League - PCL):
   ...
   - Rulebook: https://docs.google.com/document/d/e/2PACX-1vTKj_9bJ4bqYT_q2gD9wyDh24EGUH9s-35t6NaUbr2HjauNprUfFFi2WQgWIAqgXi83dseiCQa16Z9o/pub

2. VOLLEYBALL (VolleyVibes):
   - Format: Best of 3 sets. Sets 1-2 up to 15, Deciding set to 21. Win by 2 margin.
   - Requirement: 6 players on court. Min 4 to play. Rally scoring (point on every rally).
   - Rotation: Standard rotation rules apply. Foot faults result in loss of point.
   - Rulebook: https://docs.google.com/document/d/e/2PACX-1vQk0Pn79Qd75Qwu2Owaj_HwHWqtGZwwe73w99sQB8bskU4taBvmKBBAI8ZTww_ckf0cgeoJR5VML05g/pub
...
3. BADMINTON (Paradox Badminton League - PBL):
   ...
   - Rulebook: https://docs.google.com/document/d/e/2PACX-1vS-40N_0KX58mXv3x6ojSxjRpcMIWt58iuC6oz7uL-g7gqRetWm172DjMp-JrmVM5yUcOG6Sgxx3yYF/pub
...
4. KAMPUS RUN:
   ...
   - Rulebook: https://docs.google.com/document/d/e/2PACX-1vSWGI8y2yB9v-df3JQBYlg0r_nGNeNoy0eouE_WfEvxZsrrtbrWXengxOLMv1MX_l96IN5sWIHYIBz0/pub

CRITICAL CONTACTS & SUPPORT:
- For any complex disputes, registration issues, or formal grievances, contact **Sportify Core Team (Krish and Aman)** at: thesportify.society@study.iitm.ac.in
...
const vasudevFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    // Resilience: Fallback to text if structured output fails
