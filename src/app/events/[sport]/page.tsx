          ...
          <div className="space-y-8">
            ...
            <Card className="premium-card">
              <Table><TableHeader className="bg-white/5"><TableRow className="border-white/5"><TableHead className="w-16 text-center text-[9px] font-black uppercase">Pos</TableHead><TableHead className="text-[9px] font-black uppercase">Participant</TableHead><TableHead className="text-[9px] font-black uppercase">Category</TableHead><TableHead className="text-right text-[9px] font-black uppercase">Time</TableHead></TableRow></TableHeader>
                <TableBody>{runResults?.map((res) => (<TableRow key={res.id} className="h-14 border-white/5 hover:bg-white/[0.02] transition-colors"><TableCell className="text-center font-black">#{res.position}</TableCell><TableCell><p className="font-bold text-sm uppercase">{res.name}</p><p className="text-[8px] font-black text-muted-foreground uppercase">{res.gender} • {res.ageGroup}</p></TableCell><TableCell className="text-[10px] font-black uppercase text-primary">{res.category}</TableCell><TableCell className="text-right font-black tabular-nums">{res.time}</TableCell></TableRow>))}</TableBody></Table>
            </Card>
          </div>
        </section>
      ) : (
